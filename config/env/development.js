...
module.exports = {
  db: {
	  uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://admin:teamelo@ds161194.mlam.com:61194/elo_webapp' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/mean-dev',
    options: {},
