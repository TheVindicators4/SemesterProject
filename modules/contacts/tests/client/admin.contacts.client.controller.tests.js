(function () {
  ...
  describe('Contacts Admin Controller Tests', function () {
    // Initialize global variables
    var ContactsAdminController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _ContactsService_, _Notification_) {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (ContactsService) {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Contact saved successfully!' });
        // Test URL redirection after the contact was created
        expect($state.go).toHaveBeenCalledWith('admin.contacts.list');
      }));
      ...
      it('should call Notification.error if error', function () {
        ...
        expect(Notification.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="glyphicon glyphicon-remove"></i> Contact save error!' });
      });
    });
    ...
    describe('vm.save() as update', function () {
      ...
      it('should  call Notification.error if error', inject(function (ContactsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the contact and redirect to contacts', function () {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Contact deleted successfully!' });
        expect($state.go).toHaveBeenCalledWith('admin.contacts.list');
      });
